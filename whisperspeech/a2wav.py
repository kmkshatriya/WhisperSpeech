...
class Vocoder:
    def __init__(self, repo_id="charactr/vocos-encodec-24khz", local_pth=None, device=None, enc_repo=None):
        ...
        self.device = device
        self.vocos = Vocos.from_pretrained(repo_id, local_pth, enc_repo).to(device)
